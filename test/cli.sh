...
# task format c -i test/file/code/example.c -o test/hold/example.c
# task format julia -i test/file/code/example.jl -o test/hold/example.jl
# task format python -i test/file/code/example.py -o test/hold/example.py
# task format swift -i test/file/code/example.swift -o test/hold/example.swift
# task format ruby -i test/file/code/example.rb -o test/hold/example.rb
# task format kotlin -i test/file/code/example.kt -o test/hold/example.kt
# task format assembly -i test/file/code/example.asm -o test/hold/example.asn
...
# # compile
# task compile c -O binary -i test/file/code/quicksort.c -o test/hold/quicksort
...
# task compile rust -O binary -i test/file/code/quicksort/quicksort.rs -o test/hold/quicksort.rust.o
# task compile rust -O assembly -i test/file/code/quicksort/quicksort.rs -o test/hold/quicksort.rust.asm
