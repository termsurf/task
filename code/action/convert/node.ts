...
export type ConvertInput = {
  ...
  archive: {
    ...
    extend: ConvertArchiveNodeInput
  }
}
...
export async function convert(
  source: ConvertWithFontForge<FontFormat>,
): Promise<ConvertOutput>
export async function convert(
  source: ConvertTxtWithPuppeteer<'txt'>,
): Promise<ConvertOutput>
export async function convert(
  source: ConvertMarkdownWithPuppeteer<'markdown'>,
): Promise<ConvertOutput>
export async function convert(
  source: ConvertVideoWithFfmpeg<ConvertInput['ffmpeg']['input']>,
): Promise<ConvertOutput>
export async function convert(
  source: ConvertImageWithImageMagick<ConvertInput['image']['input']>,
): Promise<ConvertOutput>
export async function convert(
  source: ConvertArchive<ConvertInput['archive']['input']>,
): Promise<ConvertOutput>
export async function convert(
...
export async function convert(source) {
  ...
  if (testConvertArchiveNode(source)) {
    return await convertArchiveNode(source)
  }

  if (testConvertUnit(source)) {
    return Promise.resolve(convertUnit(source))
  }
}
